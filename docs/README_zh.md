...
表 1：基于 CV3-Eval 测试集的零样本 TTS 评测结果（阿拉伯语使用内部测试集）。报告指标：WER (%) ↓ 和说话人相似度 (SS) ↑。†为原始论文引用结果。

| 模型 | 参数量 | test-zh<br>WER (%) ↓ | test-zh<br>SS (%) ↑ | test-en<br>WER (%) ↓ | test-en<br>SS (%) ↑ | test-es<br>WER (%) ↓ | test-es<br>SS (%) ↑ | test-ja<br>WER (%) ↓ | test-ja<br>SS (%) ↑ | test-ar<br>WER (%) ↓ | test-ar<br>SS (%) ↑ | 平均<br>WER (%) ↓ | 平均<br>SS (%) ↑ |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
表 2：基于 CV3-Eval 测试集的跨语言 TTS 评测（中文提示 → 目标语言，阿拉伯语使用内部测试集）。报告指标：WER (%) ↓ 和说话人相似度 (SS) ↑。

| 模型 | 参数量 | zh→en<br>WER (%) ↓ | zh→en<br>SS (%) ↑ | zh→es<br>WER (%) ↓ | zh→es<br>SS (%) ↑ | zh→ja<br>WER (%) ↓ | zh→ja<br>SS (%) ↑ | zh→ar<br>WER (%) ↓ | zh→ar<br>SS (%) ↑ | 平均<br>WER (%) ↓ | 平均<br>SS (%) ↑ |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
